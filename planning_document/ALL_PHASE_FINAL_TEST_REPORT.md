...
deployment has not been executed. Phase 18 is blocked by live V1.16/source provenance drift.
...
| 18 | absent in selected chain | V1.16 live-only | absent | plan only | BLOCKED |
