...
export const routes:Routes=[
  ...
  {path:'customer-admin/live-monitoring',title:'Live Camera Monitoring | CustSearch AI',canActivate:[authGuard,roleGuard(tenantRoles),permissionGuard([PERMISSIONS.camerasView,PERMISSIONS.camerasPreview])],loadComponent:()=>import('./features/cameras/live-camera-monitoring-page').then(m=>m.LiveCameraMonitoringPage)},
  ...
  {path:'customer-admin/cameras/:cameraId/motion-rules',title:'Camera motion rules | CustSearch AI',canActivate:[authGuard,roleGuard(tenantRoles),permissionGuard([PERMISSIONS.camerasView])],loadComponent:()=>import('./features/cameras/camera-motion-rules-page').then(m=>m.CameraMotionRulesPage)},
  {path:'customer-admin/storage',title:'Evidence storage | CustSearch AI',canActivate:[authGuard,roleGuard(tenantRoles),permissionGuard([PERMISSIONS.storageViewUsage])],loadComponent:()=>import('./features/storage/tenant-storage-page').then(m=>m.TenantStoragePage)},
  ...
  // Phase 18 tenant/store-scoped retail security. The /admin prefix is part of the approved contract.
  {path:'admin/security/dashboard',title:'Retail security dashboard | CustSearch AI',data:{mode:'dashboard'},canActivate:[authGuard,roleGuard(tenantRoles),permissionGuard([PERMISSIONS.securityIncidentsView])],loadComponent:()=>import('./features/security/security-page').then(m=>m.SecurityPage)},
  {path:'admin/security/incidents',title:'Security incidents | CustSearch AI',data:{mode:'incidents'},canActivate:[authGuard,roleGuard(tenantRoles),permissionGuard([PERMISSIONS.securityIncidentsView])],loadComponent:()=>import('./features/security/security-page').then(m=>m.SecurityPage)},
  {path:'admin/security/incidents/:id',title:'Security incident review | CustSearch AI',data:{mode:'detail'},canActivate:[authGuard,roleGuard(tenantRoles),permissionGuard([PERMISSIONS.securityIncidentsView])],loadComponent:()=>import('./features/security/security-page').then(m=>m.SecurityPage)},
  {path:'admin/security/settings',title:'Retail security settings | CustSearch AI',data:{mode:'settings'},canActivate:[authGuard,roleGuard(tenantRoles),permissionGuard([PERMISSIONS.securitySettingsView])],loadComponent:()=>import('./features/security/security-page').then(m=>m.SecurityPage)},
  {path:'admin/security/rules',title:'Retail security rules | CustSearch AI',data:{mode:'rules'},canActivate:[authGuard,roleGuard(tenantRoles),permissionGuard([PERMISSIONS.securityRulesView])],loadComponent:()=>import('./features/security/security-page').then(m=>m.SecurityPage)},
  {path:'admin/security/reports',title:'Retail security reports | CustSearch AI',data:{mode:'reports'},canActivate:[authGuard,roleGuard(tenantRoles),permissionGuard([PERMISSIONS.securityReportsView])],loadComponent:()=>import('./features/security/security-page').then(m=>m.SecurityPage)},
  ...
  {path:'admin/tenants',canActivate:[authGuard,roleGuard(platformRoles),permissionGuard([PERMISSIONS.tenantsView])],children:[
    ...
    {path:':tenantId/storage',title:'Tenant storage | CustSearch AI',canActivate:[permissionGuard([PERMISSIONS.tenantsViewUsage])],loadComponent:()=>import('./features/storage/platform-storage-page').then(m=>m.PlatformStoragePage)},
  ]},
