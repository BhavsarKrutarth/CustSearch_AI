...
export const routes:Routes=[
  ...
  {path:'customer-admin/reports',title:'Reports & exports | CustSearch AI',data:{platform:false},canActivate:[authGuard,roleGuard(tenantRoles),permissionGuard([PERMISSIONS.tenantReportsView])],loadComponent:()=>import('./features/reports/reports-page').then(m=>m.ReportsPage)},
  {path:'customer-admin/settings',title:'Settings | CustSearch AI',data:{platform:false,mode:'settings'},canActivate:[authGuard,roleGuard(tenantRoles),permissionGuard([PERMISSIONS.settingsView])],loadComponent:()=>import('./features/operations/operations-page').then(m=>m.OperationsPage)},
  {path:'customer-admin/audit-logs',title:'Audit logs | CustSearch AI',data:{platform:false,mode:'audit'},canActivate:[authGuard,roleGuard(tenantRoles),permissionGuard([PERMISSIONS.auditLogsView])],loadComponent:()=>import('./features/operations/operations-page').then(m=>m.OperationsPage)},
  ...
  {path:'admin/reports',title:'Platform reports & exports | CustSearch AI',data:{platform:true},canActivate:[authGuard,roleGuard(platformRoles),permissionGuard([PERMISSIONS.platformReportsView])],loadComponent:()=>import('./features/reports/reports-page').then(m=>m.ReportsPage)},
  {path:'admin/system-health',title:'System health | CustSearch AI',data:{platform:true,mode:'health'},canActivate:[authGuard,roleGuard(platformRoles),permissionGuard([PERMISSIONS.systemHealthView])],loadComponent:()=>import('./features/operations/operations-page').then(m=>m.OperationsPage)},
  {path:'admin/audit-logs',title:'Audit logs | CustSearch AI',data:{platform:true,mode:'audit'},canActivate:[authGuard,roleGuard(platformRoles),permissionGuard([PERMISSIONS.platformAuditView])],loadComponent:()=>import('./features/operations/operations-page').then(m=>m.OperationsPage)},
  {path:'admin/settings',title:'Settings | CustSearch AI',data:{platform:true,mode:'settings'},canActivate:[authGuard,roleGuard(platformRoles),permissionGuard([PERMISSIONS.platformSettingsView])],loadComponent:()=>import('./features/operations/operations-page').then(m=>m.OperationsPage)},
