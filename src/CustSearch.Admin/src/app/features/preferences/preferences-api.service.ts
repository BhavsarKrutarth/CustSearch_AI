...
export class PreferencesApiService {
  ...
  interpretVoice(sessionId:number,body:{recognizedText:string;recognitionConfidence:number;preferenceType:PreferenceType;referenceId:number|null;value:string|null;reason:string|null}){return this.api.post<VoiceSession>(`voice/commands/${sessionId}/interpret`,body);}
