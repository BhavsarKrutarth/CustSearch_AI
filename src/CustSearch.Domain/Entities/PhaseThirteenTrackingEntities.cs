...
public sealed class Camera
{
    ...
    public void SetMotionRulesEnabled(bool enabled,DateTime utcNow){MotionRulesEnabled=enabled;UpdatedUtc=Utc(utcNow);}
    public void SetUseDetectionZone(bool enabled,DateTime utcNow){UseDetectionZone=enabled;UpdatedUtc=Utc(utcNow);}
