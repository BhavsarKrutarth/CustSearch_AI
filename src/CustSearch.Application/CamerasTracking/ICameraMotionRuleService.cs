...
public interface ICameraMotionRuleService
{
    ...
    Task<CameraMotionSettingsView>SetDetectionZoneAsync(long cameraId,bool enabled,TenantAuditContext audit,CancellationToken ct=default);
...
public sealed record CameraMotionSettingsView(long CameraId,bool MotionRulesEnabled,bool UseDetectionZone);
