...
public static class PermissionCatalog
{
    ...
    public static class Operations
    {
        ...
        public const string StorageViewUsage="Storage.ViewUsage";public const string CamerasViewEvents="Cameras.ViewEvents";
