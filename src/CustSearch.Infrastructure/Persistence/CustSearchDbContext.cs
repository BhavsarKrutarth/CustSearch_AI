...
public sealed class CustSearchDbContext(DbContextOptions<CustSearchDbContext> options):DbContext(options)
{
    ...
    public DbSet<Camera> Cameras=>Set<Camera>(); public DbSet<CameraZoneConfiguration> CameraZoneConfigurations=>Set<CameraZoneConfiguration>(); public DbSet<PersonTrackSession> PersonTrackSessions=>Set<PersonTrackSession>(); public DbSet<CameraTrackHandoff> CameraTrackHandoffs=>Set<CameraTrackHandoff>(); public DbSet<CameraOperationalEvent> CameraOperationalEvents=>Set<CameraOperationalEvent>(); public DbSet<CameraUserPreviewGrant> CameraUserPreviewGrants=>Set<CameraUserPreviewGrant>(); public DbSet<CameraPreviewSession> CameraPreviewSessions=>Set<CameraPreviewSession>();
