...
END;
GO
/* Reconcile the earlier operational heartbeat shape without deleting its history. The current
   Worker writes WorkerType/IsReady; defaults keep legacy required columns insert-compatible. */
