...
public sealed class PhaseElevenAlertsRealtimeServiceTests:IAsyncLifetime
{
    ...
    private sealed class FakeMetrics:IAlertConnectionMetrics{public long ActiveConnections(long tenantId)=>0;public long Reconnects(long tenantId)=>0;public long TotalActiveConnections()=>0;public long TotalReconnects()=>0;public void Connected(string connectionId,long tenantId){}public void Disconnected(string connectionId){}public void Reconnected(string connectionId,long tenantId){}}
