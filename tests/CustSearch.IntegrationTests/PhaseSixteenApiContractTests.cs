...
public sealed class PhaseSixteenApiContractTests
{
    ...
    [Fact]public void UnknownClientFieldsAreRejected(){var json="""{"scope":1,"tenantId":null,"storeId":null,"key":"Reports.PageSize","valueJson":"100","secretValue":"unsafe"}""";Assert.Throws<JsonException>(()=>JsonSerializer.Deserialize<SaveOperationalSettingRequest>(json,new JsonSerializerOptions(JsonSerializerDefaults.Web)));}
}
